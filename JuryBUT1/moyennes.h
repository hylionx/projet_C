...
void sauvegarder_decisions_jury(moyPromo *les_moyennes, const char *nom_fichier); // fonction qui permet de sauvegarder les décisions du jury dans un fichier
void afficher_decisions_jury(moyPromo *les_moyennes, FILE *fichier) // fonction qui permet d'afficher les décisions du jury
